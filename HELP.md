...
* The original package name 'com.dashboard.employee-dashboard' is invalid and this project uses 'com.dashboard.employeedashboard' instead.
...
```
$ docker run --rm -p 8080:8080 employee-dashboard:0.0.1-SNAPSHOT
```
